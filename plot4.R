...
# Plot 1
plot(x = housePowerConsume$DateTime, y = housePowerConsume$Global_active_power, type = "l", xlab = "", ylab = "Global Active Power")
...
# Plot 3
plot(x = housePowerConsume$DateTime, y = housePowerConsume$Voltage, type = "l", xlab = "datetime", ylab = "Voltage")

# Plot 4
plot(x = housePowerConsume$DateTime, y = housePowerConsume$Global_reactive_power, type = "l", xlab = "datetime", ylab = "Global_reactive_power")
